...
if (choice ==  'N' or choice == 'n'):
    accessToken = input("Please enter your access token next: ")  

else:
    accessToken = "Bearer ZDQxNTc4ODQtOTE0Yy00MGZhLWFhNDYtYzdjYzNmNmUwZTc1MDE1MTRkOTgtMmIx_PE93_34717e43-8e43-4f55-b8e9-8cf21a9f430d"
...
# 4. Create a loop to print the type and title of each room.
print("List of rooms by type and title:")
print("=================================")
print("Type \t Title")
print("=================================")
rooms = r.json()["items"]
for room in rooms:
        ...
        print (str(room["type"]) + "\t"  + str(room["title"]))
...
# 6. Provide your MapQuest API consumer key.
        mapsAPIGetParameters = { 
                                "location": location, 
                                "key": "OZUIhihfTdtjwW8GwxwAleK8tZQpuv7m"
                               }
# 7. Provide the URL to the MapQuest address API.
...
# 11. Convert the risetime epoch value to a human readable date and time.
        ...
        print(risetimeInFormattedString)
...
# 13. Complete the code to post the message to the Webex Teams room.            
        HTTPHeaders = { 
                             "Authorization": "Bearer ZDQxNTc4ODQtOTE0Yy00MGZhLWFhNDYtYzdjYzNmNmUwZTc1MDE1MTRkOTgtMmIx_PE93_34717e43-8e43-4f55-b8e9-8cf21a9f430d",
                             "Content-Type": "application/json"
                           }
        PostData = {
                            "roomId": "Y2lzY29zcGFyazovL3VybjpURUFNOmV1LWNlbnRyYWwtMV9rL1JPT00vM2FhNWRiZDAtZDgzNC0xMWVjLWFjYmMtZTc5NTU1YjM0OWYx",
                            "text": "/Washinton, DC, US"
                        }
